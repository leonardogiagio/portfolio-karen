...
export function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 27 99696-0292",
      link: "https://wa.me/5527996960292?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "karen.nunes.gg@gmail.com",
      link: "mailto:karen.nunes.gg@gmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Cariacica - ES",
      description: "Vila Capixaba",
